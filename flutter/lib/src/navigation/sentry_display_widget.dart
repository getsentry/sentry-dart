...
@Deprecated('The automatic TTID measurement is accurate enough. '
    'This widget is no longer needed and will be removed in version 9.0.0. '
    'Simply remove this widget and the TTID will be automatically measured for all screens.')
