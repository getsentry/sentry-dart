...
set(sentry_flutter_bundled_libraries $<TARGET_FILE:crashpad_handler> PARENT_SCOPE)

if(WIN32)
    set(sentry_flutter_bundled_libraries ${sentry_flutter_bundled_libraries} $<TARGET_FILE:crashpad_wer> PARENT_SCOPE)
endif()
