...
class MockSentryTracer extends _i1.Mock implements _i8.SentryTracer {
  ...
  _i3.SentryTransactionNameSource get transactionNameSource =>
      (super.noSuchMethod(Invocation.getter(#transactionNameSource),
  ...
  Map<String, _i2.SentryMeasurement> get measurements =>
      (super.noSuchMethod(Invocation.getter(#measurements),
  ...
  @override
  void setMeasurement(String? name, num? value,
...
class MockSentryNative extends _i1.Mock implements _i10.SentryNative {
  ...
  @override
  _i6.Future<void> setContexts(String? key, dynamic value) =>
      (super.noSuchMethod(Invocation.method(#setContexts, [key, value]),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as _i6.Future<void>);
  @override
  _i6.Future<void> removeContexts(String? key) =>
      (super.noSuchMethod(Invocation.method(#removeContexts, [key]),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as _i6.Future<void>);
  @override
  _i6.Future<void> setUser(_i3.SentryUser? sentryUser) =>
      (super.noSuchMethod(Invocation.method(#setUser, [sentryUser]),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as _i6.Future<void>);
  @override
  _i6.Future<void> addBreadcrumb(_i3.Breadcrumb? breadcrumb) =>
      (super.noSuchMethod(Invocation.method(#addBreadcrumb, [breadcrumb]),
          ...
          returnValueForMissingStub: Future<void>.value()) as _i6.Future<void>);
  @override
  _i6.Future<void> clearBreadcrumbs() =>
      (super.noSuchMethod(Invocation.method(#clearBreadcrumbs, []),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as _i6.Future<void>);
  @override
  _i6.Future<void> setExtra(String? key, dynamic value) =>
      (super.noSuchMethod(Invocation.method(#setExtra, [key, value]),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as _i6.Future<void>);
  @override
  _i6.Future<void> removeExtra(String? key) =>
      (super.noSuchMethod(Invocation.method(#removeExtra, [key]),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as _i6.Future<void>);
  @override
  _i6.Future<void> setTag(String? key, String? value) =>
      (super.noSuchMethod(Invocation.method(#setTag, [key, value]),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as _i6.Future<void>);
  @override
  _i6.Future<void> removeTag(String? key) =>
      (super.noSuchMethod(Invocation.method(#removeTag, [key]),
          returnValue: Future<void>.value(),
          returnValueForMissingStub: Future<void>.value()) as _i6.Future<void>);
  @override
...
class MockHub extends _i1.Mock implements _i2.Hub {
  ...
  _i6.Future<_i3.SentryId> captureTransaction(
      ...
      (super.noSuchMethod(
              Invocation.method(#captureTransaction, [transaction],
