  ...
  group('$SpanFrameMetrics', () {
    ...
    test('applyTo sets data and measurements on root spans', () {
      ...
      verify(span.setMeasurement(
              SpanFrameMetricKey.totalFrames.measurement, 10))
          .called(1);
      verify(span.setMeasurement(SpanFrameMetricKey.slowFrames.measurement, 2))
          .called(1);
      verify(span.setMeasurement(
              SpanFrameMetricKey.frozenFrames.measurement, 1))
          .called(1);
      verify(span.setMeasurement(
              SpanFrameMetricKey.framesDelay.measurement, 30))
          .called(1);
    });
  });
}
