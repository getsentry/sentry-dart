import 'package:sentry/src/telemetry/log/sentry_template_string.dart';
...
void main() {
  ...
  group('SentryTemplateString', () {
    ...
    test(
      'unsupported type with throwing toString() falls back to empty string',
      () {
        final sut = fixture.getSut("The object is %s", [
