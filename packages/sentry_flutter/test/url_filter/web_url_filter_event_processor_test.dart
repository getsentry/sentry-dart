...
import 'package:sentry_flutter/src/url_filter/url_filter_event_processor.dart';

import '../mocks.dart';

// can be tested on command line with
// `flutter test --platform=chrome test/url_filter/web_url_filter_event_processor_test.dart`
// The URL looks something like this: http://localhost:58551/url_filter/web_url_filter_event_processor_test.html
