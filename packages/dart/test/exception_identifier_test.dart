...
void main() {
  ...
  group('ExceptionTypeIdentifiers', () {
    test('should be processed based on order in the list', () {
      fixture.options.prependExceptionTypeIdentifier(
        DartExceptionTypeIdentifier(),
      );
      fixture.options.prependExceptionTypeIdentifier(
        ObfuscatedExceptionIdentifier(),
      );
  ...
  group('CachingExceptionTypeIdentifier', () {
    ...
    test('should return cached result for known types', () {
      ...
      expect(
        cachingIdentifier.identifyType(exception),
  ...
  group('Integration test', () {
    ...
    test(
      ...
      () async {
        ...
        expect(
          capturedEvent.exceptions!.first.type,
          equals('ObfuscatedException'),
        );
      },
    );
