...
/// Marker class to represent unset/not provided span for startSpan.
///
/// Since Dart does not have 'undefined' we use this class to circumvent that
/// issue. This is used internally to distinguish between "no span provided"
/// and "null span explicitly provided".
@internal
final class UnsetSentrySpanV2 implements SentrySpanV2 {
  ...
  SentrySpanV2 get segmentSpan => _throw();
}
