...
void main() {
  ...
  group('Replay recording', () {
    ...
    testWidgets(
      'captureReplay only returns an ID while recording',
      (tester) async {
        await setupSentryAndApp(tester);
    ...
    testWidgets(
      'manual replay controls complete on mobile',
      (tester) async {
        await setupSentryAndApp(tester);
    ...
    testWidgets(
      'manual start records when automatic sampling is disabled',
      (tester) async {
    ...
    testWidgets(
      'close tears down the native replay integration on Android',
      (tester) async {
        await setupSentryAndApp(tester);
