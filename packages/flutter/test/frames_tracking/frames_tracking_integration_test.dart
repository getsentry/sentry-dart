...
import 'package:sentry_flutter/src/frames_tracking/frames_tracking_integration.dart';
    ...
    testWidgets('with stream lifecycle measures frames', (
      ...
      await tester.runAsync(() async {
        final testWidget = buildTestApp(
          ...
          onPressed: () {
            parentSpan = hub.startInactiveSpan('test_parent_span');
            childSpan = hub.startInactiveSpan('test_child_span');
          },
        );
