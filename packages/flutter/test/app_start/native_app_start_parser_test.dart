...
void main() {
  ...
  group('parseNativeAppStart', () {
    test('returns info with cold type and sorted native spans', () {
      ...
      expect(info!.type, AppStartType.cold);
      expect(info.start, DateTime.fromMillisecondsSinceEpoch(0));
      expect(info.end, fixture.appStartEnd);
      expect(
        info.nativeSpanTimes.map((s) => s.description),
