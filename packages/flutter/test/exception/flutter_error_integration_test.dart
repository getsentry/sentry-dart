...
void main() {
  group(FlutterErrorIntegration, () {
    ...
    test(
      ...
      () async {
        ...
        final throwableMechanism =
            event.throwableMechanism as ThrowableMechanism;
        ...
        expect(
          event.contexts['flutter_error_details']['context'],
          'thrown while handling a gesture',
        );
        expect(
          event.contexts['flutter_error_details']['information'],
          'foo bar',
        );
      },
      onPlatform: {
    ...
    test(
      'captures error with long FlutterErrorDetails.information',
      () async {
        final details = FlutterErrorDetails(
