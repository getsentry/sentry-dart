...
fvm dart run ffigen --config ffi-cocoa.yaml
...
sed -i.bak 's|void setLevel(SentryLevel level)|void setLevel(SentryLevel$1 level)|g' $binding
rm $binding.bak
fvm dart format $binding
